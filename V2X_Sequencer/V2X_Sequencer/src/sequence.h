...
//#include "../common/v2xcomm.h" //removed file added info  to user_board.h
#include "./ASF/common/boards/board.h"

#define SEQ_MOSI EXT1_PIN_MOSI //DS
#define SR_LATCH EXT1_PIN_SR_LATCH	//ST_CP
#define SEQ_SCK  EXT1_PIN_SCK	//SH_CP
#define SR_CLEAR EXT1_PIN_SR_CLEAR	//MR
