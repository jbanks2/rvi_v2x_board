...
#define EXT1_PIN_SPI_SS           EXT1_PIN_SPI_SS
#define EXT1_PIN_SPI_MOSI         EXT1_PIN_SPI_MOSI
#define EXT1_PIN_SPI_MISO         EXT1_PIN_SPI_MISO
#define EXT1_PIN_SPI_SCK          EXT1_PIN_SPI_SCK
